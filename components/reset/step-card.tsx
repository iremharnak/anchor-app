...
export function StepCard({ step, stepNumber, totalSteps }: StepCardProps) {
  return (
    <section
      ...
      className="rounded-2xl border border-stone-200/80 bg-anchor-surface/55 px-5 py-7 md:px-8 md:py-9"
    >
      <div className="space-y-6 md:space-y-7">
        ...
        <div className="max-w-[60ch]">
          <p className="whitespace-pre-line font-anchor-sans text-base md:text-[1.0625rem] leading-8 md:leading-[1.85] text-anchor-text-body">
            {step.body}
          </p>
        </div>
      </div>
